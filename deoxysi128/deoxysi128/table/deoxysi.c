/*
 * Deoxys-I Table-Based C Implementation
 *
 * Copyright 2016:
...
#define DEOXYS_I_VERSION 128 // for Deoxys-I-128
// #define DEOXYS_I_VERSION 256 // for Deoxys-I-256
...
#if DEOXYS_I_VERSION==128
    #define TWEAKEY_STATE_SIZE    256    
#elif DEOXYS_I_VERSION==256
    #define TWEAKEY_STATE_SIZE    384    
#endif

/**********************************************************************************
*** In Deoxysi-128-128, the tweak is on 128 bits:
